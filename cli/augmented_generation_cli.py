...
from lib.summarize_command import citations_command, question_command, summarize_command
...
def main() -> None:
    ...
    citations_parser = subparsers.add_parser("citations", help="Perform RAG with citation-aware answer")
    citations_parser.add_argument("query", type=str, help="Search query for RAG")
    citations_parser.add_argument("--limit", type=int, default=RRF_SEARCH_LIMIT, help="search result limit")

    question_parser = subparsers.add_parser("question", help="Answer a conversational movie question")
    question_parser.add_argument("question", type=str, help="Question to answer")
    question_parser.add_argument("--limit", type=int, default=RRF_SEARCH_LIMIT, help="search result limit")
